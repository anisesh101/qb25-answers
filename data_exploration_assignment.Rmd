...
Liver_Count <- filter(dt, Liver > TPM)
print(Liver_Count)
# 13499 Genes above threshold for TPM = 1
# 5132 Genes above threshold for TPM = 10

Testis_Count <- filter(dt, Testis > TPM)
print(Testis_Count)
# 25064 Genes above threshold for TPM = 1
# 11471 Genes above threshold for TPM = 10

Whole_Blood_Count <- filter(dt, Whole_Blood_Count > TPM)
print(Whole_Blood_Count)
# 56200 Genes above threshold for TPM = 1
# 56200 Genes above threshold for TPM = 10
...
#For TPM above 10, all tissues except for Whole Blood had changes in the number of genes expressing above that threshold. The other two tissues had a reduction of genes expressing above the threshold.
```
